...
public class CartController {
    ...
    public void removeItem(@ModelAttribute("productId") Long productId) {
        ProductDTO productDTO = this.productService.getProduct(productId);
        this.cartService.removeItem(productDTO);
    }
    ...
    public void updateItem(@ModelAttribute("productId") Long productId, @ModelAttribute("quantity") int quantity) {
        ProductDTO productDTO = this.productService.getProduct(productId);
