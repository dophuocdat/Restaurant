...
public class OrderController {
    ...
    @PreAuthorize("hasAuthority('USER')")
    public String ordersById(@PathVariable Long id, Model model) {
    ...
    public String orderPlaced(@RequestParam("id") Long uuid, @RequestParam("emailId") String emailId, Model model) {
